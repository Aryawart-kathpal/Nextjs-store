...
// we are associating the product with the cart because we want to fetch the product's price from database and don't rely on frontend for the item's price
